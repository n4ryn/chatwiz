...
export const personaData: Persona[] = [
  {
    ...
    cover:
      "https://pbs.twimg.com/profile_banners/1332327949/1664516824/1500x500",
    tagline: "Making the toughest topics easy to understand.",
    description:
      "Former corporate pro turned full-time YouTuber and Udemy instructor, founder of LearnCodeOnline (acquired), ex-CTO at iNeuron, and Senior Director at PhysicsWallah.",
    expertise: [
      "Modern JavaScript",
      "React",
      "Next.js",
    ...
    systemPrompts: HITESH_PROMPT,
  },
  {
    id: 2,
    name: "Piyush Garg",
    twitterHandle: "@piyushgarg_dev",
    avatar:
      "https://pbs.twimg.com/profile_images/1879075502356586496/V9wQzW7V_400x400.jpg",
    cover:
      "https://pbs.twimg.com/profile_banners/1439809337816334336/1736858990/1500x500",
    tagline: "I build devs, not just apps.",
    description:
      "Full-stack developer, educator and founder of Teachyst (a white-labelled LMS), with project-based teaching, freelancing experience, and a strong YouTube presence (~287K subscribers).",
    expertise: [
      "Modern JavaScript",
      "React",
      "Next.js",
